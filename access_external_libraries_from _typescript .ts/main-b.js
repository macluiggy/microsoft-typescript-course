...
define("greetings-utilities_modules", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
  ...
  function returnGreeting(greeting) {
    ...
    console.log(
      "The message from GreetingsLength_module is " +
        greeting +
        ". It is " +
        greetingLength +
        " characters long."
...
define("main", [
  ...
  "greetings_module",
  "greetings_module",
  "greetings-utilities_modules",
], function (
  require,
  exports,
  greetings_module_1,
  allGreetingFunctions,
  greetings_utilities_modules_1
) {
  "use strict";
  exports.__esModule = true;
