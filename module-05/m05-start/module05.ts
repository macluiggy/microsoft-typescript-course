...
class BuildArray {
    ...
    set sortOrder(sortOrder: 'ascending' | 'descending') { this._sortOrder = sortOrder; }
...
//console.log(testArray1._items); //aqui es privado, pero si es transpidalo a javascript ahi si se podra obtener este valor de esa manera sin tener que usar el getter