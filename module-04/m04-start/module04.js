...
function loanCalculator(items) {
    var principle = items.principle, interestRate = items.interestRate, _a = items.months, months = _a === void 0 ? 12 : _a;
    var interest = interestRate / 1200; // Calculates the monthly interest rate
    var payment;
    payment = principle * interest / (1 - (Math.pow(1 / (1 + interest), months)));
    return payment.toFixed(2);
}
var myLoan = loanCalculator({ principle: 1000, interestRate: 5 });
console.log(myLoan);
